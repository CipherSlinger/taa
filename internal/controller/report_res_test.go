...
func TestReportResIncludesTrainingReport(t *testing.T) {
	...
	report := `{"schema_version":"1.0","training_task":{"status":"succeeded"},"codeaudit":{"conclusion":{"passed":true,"risk_level":"NONE","summary":"ok","recommendation":"none","statistics":{"high":0,"medium":0,"low":0}},"file_reports":null}}`
